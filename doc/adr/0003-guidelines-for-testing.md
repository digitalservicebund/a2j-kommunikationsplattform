...
- [Prism](https://stoplight.io/open-source/prism)
  - CLI tool is great and delivers data in no time. For example by running `prism mock data/api/swagger.json`.
- [MSW](https://mswjs.io/)
...
- [Mockoon CLI](https://mockoon.com/)
  - CLI tool is great and delivers data in no time, for example with `mockoon-cli start --data data/api/swagger.json`.
...
As soon as the mock/stub is running (e.g. with [Mockoon CLI](https://mockoon.com/cli/) `mockoon-cli start --data data/api/swagger.json`) simple API calls can be made. For example `curl -i -X "GET" "http://localhost:3000/api/v1/verfahren?limit=10&offset=0" -H "accept: application/json" -H "X-User-ID: TestId"`:
