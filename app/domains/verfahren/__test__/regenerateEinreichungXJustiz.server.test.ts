...
vi.mock("../fetchDokumente", () => ({ default: mocks.fetchDokumente }));
vi.mock("../fetchDokument", () => ({ default: mocks.fetchDokument }));
vi.mock("../deleteDokument.server", () => ({ default: mocks.deleteDokument }));
vi.mock("../fetchEinreichungXJustiz.server", () => ({
  default: mocks.fetchEinreichungXJustiz,
}));
vi.mock("../uploadDokument.server", () => ({ default: mocks.uploadDokument }));
