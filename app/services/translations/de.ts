export const de = {
  buttons: {
    ...
    LOGIN_BUTTON_TEST_LABEL: "Test-Login",
  ...
  alerts: {
    ...
    LOGIN_ERROR_TEST_TITLE: "Fehler beim Test-Login",
    LOGIN_ERROR_TEST_MESSAGE:
      "Die Anmeldung über den Test-Login ist fehlgeschlagen. Bitte versuchen Sie es erneut.",
