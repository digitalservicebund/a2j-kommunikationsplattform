...
vi.mock("~/config/config.server", () => ({
  serverConfig: () => ({
    ...
    KOMPLA_IDP_OIDC_CLIENT_ID: "api-client",
    KOMPLA_IDP_OIDC_CLIENT_SECRET: "api-client-secret",
    KOMPLA_IDP_OIDC_BRAK_TOKEN_ENDPOINT: "https://api-issuer.example",
    KOMPLA_IDP_OIDC_ISSUER: "https://demo-issuer.example",
    KOMPLA_MAGIC_LINK_SERVICE_CLIENT_ID: "demo-service-client",
    KOMPLA_MAGIC_LINK_SERVICE_CLIENT_SECRET: "demo-service-secret",
    KOMPLA_MAGIC_LINK_CLIENT_ID: "demo-client",
    KOMPLA_MAGIC_LINK_REDIRECT_URI: "https://demo-redirect.example",
    KOMPLA_MAGIC_LINK_DEMO_USERNAME: "demo",
    KOMPLA_MAGIC_LINK_DEMO_EMAIL: "demo@example.com",
